...
<head>
  ...
  <title>🏭 Mis Tareas de Producción - Concentrados El Gordito</title>
...
<body id="page-top">
    ...
    <div id="content-wrapper">
      <div class="container-fluid py-4">
        ...
        <ol class="breadcrumb bg-white shadow-sm rounded-lg mb-4 py-2 px-3 border">
          ...
          <li class="breadcrumb-item active text-dark font-weight-bold"><i class="fas fa-industry mr-1"></i> Mis Órdenes de Producción</li>
        </ol>
        ...
        <div class="card card-custom mb-4">
          ...
          <div class="card-body p-4">
            <div class="table-responsive">
              <table class="table table-custom table-hover" id="tablaProduccionIn" width="100%" cellspacing="0">
                <thead>
                  <tr>
  ...
  <script>
    let dtProduccionIn = null;
    $(document).ready(function() {
      dtProduccionIn = $('#tablaProduccionIn').DataTable({
        order: [[0, 'desc']],
        pageLength: 15,
        language: {
      ...
      $('.btn-filter').on('click', function() {
        ...
        if (filterVal) {
          dtProduccionIn.column(2).search(filterVal, true, false).draw();
        } else {
          dtProduccionIn.column(2).search('').draw();
        }
      });
    });
