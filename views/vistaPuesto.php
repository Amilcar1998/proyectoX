   ...
   <div id="wrapper">
     ...
     <div id="content-wrapper">
       <div class="container-fluid">
         ...
         <h2 class="text-center mb-4">Puesto</h2>
           ...
           <div class="modal-dialog" role="document">
             <div class="modal-content">
               <div class="modal-header bg-info text-white">
                 <h5 class="modal-title" id="formModalLabel">Registro de Puesto</h5>
               ...
               <div class="modal-body">
                 <form method="POST" name="formulario">
                   <div class="form-group">
                     ...
                     <input type="text" name="txtId" value="" class="form-control" readonly>
                   </div>
                   <div class="form-group">
                     <label>Nombre Puesto</label>
                     <input type="text" name="txtNombre" value="" class="form-control" placeholder="Nombre Puesto">
                   </div>
