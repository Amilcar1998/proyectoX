...
<head>
    ...
    <meta name="description" content="Gestión de Pedidos - Concentrados El Gordito">
...
<body id="page-top">
        ...
        <div id="content-wrapper">
            <div class="container-fluid py-4">
                ...
                <ol class="breadcrumb bg-white shadow-sm rounded-lg mb-4 py-2 px-3 border">
                    ...
                    <li class="breadcrumb-item active text-dark font-weight-bold"><i class="fas fa-box-open mr-1"></i> Gestión de Pedidos</li>
                </ol>

                <?php
                // Conteo de pedidos para los filtros rápidos
                ...
                <div class="card card-custom mb-4">
                    <div class="card-header bg-white py-3 border-bottom d-flex flex-wrap justify-content-between align-items-center">
                        <div class="mb-2 mb-md-0">
                            ...
                            <small class="text-muted">Consulta, filtra y gestiona las órdenes de clientes con desglose de producción en tiempo real.</small>
                        </div>
                    </div>
                    ...
                    <div class="card-body p-4">
                        <div class="table-responsive">
                            <table class="table table-custom table-hover" id="tablaPedidos" width="100%" cellspacing="0">
                                <thead>
                                    <tr>
                                ...
                                <tbody>
                                    <?php if (!empty($datos) && is_array($datos)): ?>
                                        <?php foreach ($datos as $row): 
                                            ...
                                            $nombreEmpresa = htmlspecialchars((string)($row['nombreEmpresa'] ?? 'Concentrados El Gordito'));
                                            ...
                                            <tr>
                                                ...
                                                <?php if (!empty($esSuperUsuario)): ?>
                                                    <td class="align-middle">
                                                        <span class="badge badge-primary px-2 py-1"><i class="fas fa-building mr-1"></i><?= $nombreEmpresa ?></span>
                                                    </td>
                                                <?php endif; ?>
                                                <td class="align-middle">
            ...
            <div class="modal-content shadow-lg border-0">
                ...
                <div class="modal-footer bg-white py-3 px-4 d-flex justify-content-between border-top">
                    ...
                    <div class="d-flex align-items-center">
                        ...
                        <form action="controllerProduccion.php" method="POST" id="formPasarProduccion" class="mr-2">
    ...
    <script>
        let dataTablePedidos = null;

        $(document).ready(function() {
            // Inicializar DataTable
            dataTablePedidos = $('#tablaPedidos').DataTable({
                order: [[0, 'desc']],
                pageLength: 15,
                language: {
            ...
            $('.btn-filter').on('click', function() {
                ...
                if (filterVal) {
                    dataTablePedidos.column(4).search(filterVal, true, false).draw();
                } else {
                    dataTablePedidos.column(4).search('').draw();
                }
            });

            // Manejar clic en "Detalle"
