...
$actividadModulos = $auditoria->getActividadPorModulo();
...
<head>
   ...
   <title>Actividad por Modulo | Concentrados El Gordito</title>
   ...
   <div id="wrapper">
      ...
      <div id="content-wrapper">
         <div class="container-fluid">
            <h2 class="text-center mb-4"><i class="fas fa-th-large"></i> Actividad por Modulo</h2>
            <p class="text-center text-muted mb-4">Modulos mas utilizados en el sistema</p>

            <div class="card mb-3">
               <div class="card-header"><i class="fas fa-table"></i> Accesos por Modulo</div>
               <div class="card-body">
                  <div class="table-responsive">
                     <table class="table table-bordered datatable" width="100%" cellspacing="0">
                        ...
                        <tbody>
                           <?php foreach ($actividadModulos as $m): ?>
                           <tr>
                              <td><?php echo htmlspecialchars($m['modulo']); ?></td>
                              <td><?php echo $m['total']; ?></td>
                              <td><?php echo $m['usuarios_unicos']; ?></td>
                              <td><?php echo date('d/m/Y H:i', strtotime($m['primer_acceso'])); ?></td>
                              <td><?php echo date('d/m/Y H:i', strtotime($m['ultimo_acceso'])); ?></td>
                           </tr>
                           <?php endforeach; ?>
                           <?php if (empty($actividadModulos)) echo '<tr><td colspan="5" class="text-center">Sin registros</td></tr>'; ?>
                        </tbody>
                     </table>
                  </div>
               </div>
